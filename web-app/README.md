...
- 🧾 **Lawson Payment Check:** อัปโหลดไฟล์ `.xlsx` ที่ Lawson แจ้งจ่าย ระบบจะนำเลขบิลจากบรรทัดถัดจากรหัสสาขามารวมเป็นหนึ่งแถว เรียงตามสาขา และสรุปจำนวนบิลกับยอดจ่ายรายสาขา
...
### ตรวจไฟล์ที่ Lawson แจ้งจ่าย

1. ไปที่ส่วน **จัดรายการไฟล์ที่ Lawson แจ้งจ่าย**
2. เลือกไฟล์ `.xlsx` ที่ได้รับจาก Lawson
3. กด **ดาวน์โหลดไฟล์ตรวจ**
4. ไฟล์ผลลัพธ์จะมีชีต `รายการบิลที่จ่าย` และ `สรุปตามสาขา` พร้อมช่องเลือกสถานะ `รอตรวจ / ครบ / ไม่ครบ`
